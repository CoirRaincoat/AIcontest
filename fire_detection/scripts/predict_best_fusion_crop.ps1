param(
    ...
    [string]$Source,
    [string]$Output = "C:\AI\fire_detection\outputs\submission_best_fusion_crop.json",
    [double]$CropThreshold = 0.97
)
...
$cropCheckpoint = "C:\AI\fire_detection\runs_siglip\siglip2_crop_v2_seed2026\best_head.pt"
...
& $python "src\predict_best_fusion.py" `
    ...
    --dino-threshold 0.08 `
    --crop-checkpoint $cropCheckpoint `
    --crop-threshold $CropThreshold `
    --crop-proposal-conf 0.03
exit $LASTEXITCODE
