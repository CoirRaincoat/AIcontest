...
& "C:\ANACONDA2\envs\torch_gpu\python.exe" -c "from ultralytics import YOLO; YOLO('yolov8n.pt').train(data='data/data.yaml', epochs=1, imgsz=640, batch=8, device=0, workers=0, project='runs/train', name='gpu_smoke_test', exist_ok=True, pretrained=True, plots=False, save=False)"
exit $LASTEXITCODE
